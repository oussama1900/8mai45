...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.getMonthViewStartDay=a,exports.getMonthViewEndDay=d;var t=require("dayjs"),e=r(t);function r(t){return t&&t.__esModule?t:{default:t}}function a(t,r,a){var d=Number(r),u=(0,e.default)(t).startOf(a);return u.day()!==d&&(u=u.subtract(u.day(),"day")),u=u.add(r,"day")}function d(t){return this.getMonthViewStartDay().add(6,"week")}
},{"dayjs":19}],17:[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default={methods:{genWeekTitle:function(e){var t=this.prefixCls+"-week-title",s=this.weekDateShort||this.weekLocaleData||this.localeData[this.locale],i=this.firstDay-1,a=s.map(function(a){return++i>=7&&(i=0),e("div",{class:[t+"-item"]},[s[i]])});return e("div",{class:[t]},[a])},genCalendateItem:function(e){var t=this,s=this.genItemRow(e),i=[];return this.monthData.map(function(a,l){var o=e("div",{class:t.prefixCls+"-day-item"},[t.$scopedSlots.default?t.$scopedSlots.default(a):t.$slots.default]);s.children.push(o),l-1>0&&(l+1)%7==0&&(i.push(s),s=t.genItemRow(e))}),e("div",{class:[this.prefixCls+"-body"]},[i])},genItemRow:function(e){return e("div",{class:[this.prefixCls+"-body-row"]},[])}}};
},{}],18:[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("dayjs"),t=r(e);function r(e){return e&&e.__esModule?e:{default:e}}exports.default={props:{renderHeader:Function},computed:{headerDateText:function(){return"week"===this.mode?(0,t.default)(this.formatedDay).startOf("week").format("YYYY-MM-DD")+" - "+(0,t.default)(this.formatedDay).endOf("week").format("YYYY-MM-DD"):(0,t.default)(this.formatedDay).format("YYYY-MM")}},methods:{genHeaderCenter:function(e){var t=e("a",{class:[this.prefixCls+"-control",this.prefixCls+"-prev"],on:{click:this.prev}},[this.prevNode||"<"]),r=e("a",{class:[this.prefixCls+"-control",this.prefixCls+"-next"],on:{click:this.next}},[this.nextNode||">"]),s=e("span",{class:[this.prefixCls+"-header-date"]},[this.headerDateText]);return this.renderHeader?this.renderHeader({prev:this.prev,next:this.next,selectedDate:this.headerDateText}):e("div",{class:[this.prefixCls+"-header-center"]},[t,s,r])},genHeader:function(e){var t=e("div",{class:[this.prefixCls+"-header-left"]},[this.$slots["header-left"]]),r=e("div",{class:[this.prefixCls+"-header-right"]},[this.$slots["header-right"]]);return e("div",{class:[this.prefixCls+"-header"]},[t,this.genHeaderCenter(e),r])}}};
},{"dayjs":19}],13:[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var t=Object.assign||function(t){for(var e=1;e<arguments.length;e++){var a=arguments[e];for(var r in a)Object.prototype.hasOwnProperty.call(a,r)&&(t[r]=a[r])}return t};require("../style/calendar.less");var e=require("./date-func"),a=require("./components/body"),r=u(a),n=require("./components/header"),i=u(n),o=require("dayjs"),s=u(o);function u(t){return t&&t.__esModule?t:{default:t}}var d="vue-calendar";function h(t){return Object.prototype.toString.call(t)}exports.default={name:d,mixins:[r.default,i.default],props:{startDate:[Number,String,Date],dateData:[Object,Array],matchKey:{type:String,default:"date"},locale:{type:String,default:"en"},firstDay:{type:Number,default:0},mode:{type:String,default:"month",validator:function(t){return"month"===t||"week"===t}},prefixCls:{type:String,default:d},weekDateShort:Array,onMonthChange:{type:Function,default:function(){}},onPrev:{type:Function,default:function(){}},onNext:{type:Function,default:function(){}},renderHeader:Function,weekLocaleData:Array},computed:{formatedDay:function(){return(0,s.default)(new Date(this.currentDay))},monthData:function(){var a=this,r=this.dateData,n=this.formatedDay,i=this.firstDay,o=this.mode,u=this.matchKey,d=h(r);if(!n)return[];var f=(0,e.getMonthViewStartDay)(n,i,o),c=[],D=6;"week"===this.mode&&(D=1);for(var y=function(e){var n=[];"[object Object]"===d?Object.keys(r).forEach(function(t){var e=t.replace(/-/g,"/");f.isSame((0,s.default)(new Date(e)))&&n.push(r[t])}):"[object Array]"===d&&(n=r.filter(function(t){var e=t[u].replace(/-/g,"/");return f.isSame((0,s.default)(new Date(e)))})),c.push(t({},a.getItemStatus(f),{data:n||{},date:{year:f.year(),month:f.month()+1,date:f.date(),day:f.day(),full:f.format("YYYY-MM-DD")}})),f=f.add(1,"day")},l=0;l<7*D;l++)y();return c}},methods:{changeDate:function(t){if("string"!=typeof t&&"[object Date]"!==Object.prototype.toString.call(t))return console.error("invalied date!"),!1;this.currentDay=t},prev:function(){var t=this.formatedDay,e=this.mode,a=this.onPrev,r=this.monthData;this.currentDay=t.subtract(1,e).startOf(e).format("YYYY-MM-DD"),a({startDay:r[0].date,endDay:r[r.length-1].date})},next:function(){var t=this.formatedDay,e=this.mode,a=this.onNext,r=this.monthData;this.currentDay=t.add(1,e).startOf(e).format("YYYY-MM-DD"),a({startDay:r[0].date,endDay:r[r.length-1].date})},getItemStatus:function(t){var e=(0,s.default)(t),a=this.formatedDay,r=e.month()===a.month(),n=!r&&e.isBefore(this.formatedDay,"month"),i=!r&&e.isAfter(this.formatedDay,"month");return{isPrevMonth:n,isPrevLastDay:!!n&&e.isSame(e.endOf("month").format("YYYY-MM-DD")),isNextMonth:i,isNextFirstDay:!!i&&e.isSame(e.startOf("month").format("YYYY-MM-DD")),isToday:t.format("YYYY-MM-DD")===(0,s.default)(this.today).format("YYYY-MM-DD"),isCurMonth:r}},changeViewData:function(){this.onMonthChange({startDay:this.monthData[0].date,endDay:this.monthData[this.monthData.length-1].date})}},watch:{startDate:{immediate:!0,handler:function(t){this.currentDay=t?new Date(t):new Date,this.today||(this.today=this.currentDay)}},currentDay:{immediate:!0,handler:function(t,e){this.changeViewData()}},mode:function(t){this.changeViewData()}},data:function(){return{today:this.currentDay,currentDay:null,localeData:{"zh-cn":"周日_周一_周二_周三_周四_周五_周六".split("_"),en:"Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_")}}},render:function(t){return t("div",{class:[this.prefixCls,"is-"+this.mode]},[this.genHeader(t),this.genWeekTitle(t),this.genCalendateItem(t)])}};
},{"../style/calendar.less":15,"./date-func":16,"./components/body":17,"./components/header":18,"dayjs":19}],9:[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=require("./calendar");function r(e){return e&&e.__esModule?e:{default:e}}Object.defineProperty(exports,"default",{enumerable:!0,get:function(){return r(e).default}});
},{"./calendar":13}],7:[function(require,module,exports) {
"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=new Date,t=e.getFullYear(),a=e.getMonth()+1,r=e.getDate(),i=[{date:t+"-"+a+"-"+r,title:"buy something"},{date:t+"-"+a+"-"+r,title:"shopping"},{date:t+"-"+(a+1)+"-2",title:"remember homework"},{date:t+"-"+(a+1)+"-15",title:"music festival"},{date:t+"-"+(a+2)+"-6",title:"a course of lectures"}],l={};i.forEach(function(e){l[e.date]={title:e.title}}),exports.default={Array:i,Object:l};
},{}],4:[function(require,module,exports) {
var e=require("vueify/lib/insert-css").insert(".vue-calendar{background:#fff;display:flex;flex-direction:column}.vue-calendar-header{position:relative;padding:20px;display:flex;align-items:center}.vue-calendar-header-center{flex:1;text-align:center;font-size:14px;color:#19a0ff}.vue-calendar-header-left,.vue-calendar-header-right{flex:1}.vue-calendar-header-date{display:inline-block;margin:0 32px}.vue-calendar-control{cursor:pointer}.vue-calendar-week-title{display:flex;border-color:#e8ebee;border-style:solid;border-width:1px 0 1px 1px}.vue-calendar-week-title-item{flex:1;height:30px;line-height:30px;padding:0 15px;color:#19a0ff}.vue-calendar-body{display:flex;flex-direction:column;flex:1}.vue-calendar-body-row{flex:1;display:flex;height:5em}.vue-calendar-day-item{flex:1;overflow:hidden;border-color:#e8ebee;border-style:solid;border-width:0 0 1px 1px}*{box-sizing:border-box}body,html{height:100%;margin:0;padding:0}body{font-family:-apple-system,BlinkMacSystemFont,Segoe UI,Roboto,PingFang SC,Hiragino Sans GB,Microsoft YaHei,Helvetica Neue,Helvetica,Arial,sans-serif;color:#333;background-image:linear-gradient(60deg,#fb7bb0,#fb7bce)}h1,h2{color:#fff;text-align:center;text-shadow:0 3px 1px #f81875;margin:0;font-family:Georgia,Times New Roman,Times,serif}h1{font-size:2.4rem}.page-container{height:100%;display:flex;flex-direction:column;padding-top:40px}.container{width:80%;margin:0 auto;flex:1;height:100%}.ui-calendar{margin-top:20px;box-shadow:0 1px 5px #f81875;border-radius:5px;height:90%}.ui-calendar-header__left>button{font-size:12px}.ui-calendar-header__left>button:nth-child(2){margin-left:-4px}.ui-calendar-modeBtn{position:relative;display:inline-block;background:#fff;border:1px solid #ff7dc5;color:#ff7dc5;padding:5px 1em;font-size:13px;line-height:1;box-shadow:0 1px 3px #ffcae7;min-width:5em;margin-right:-1px;text-align:center;cursor:pointer}.ui-calendar-modeBtn:first-child{border-top-left-radius:3px;border-bottom-left-radius:3px}.ui-calendar-modeBtn:last-child{border-bottom-right-radius:3px;border-top-right-radius:3px}.ui-calendar-modeBtn:active,.ui-calendar-modeBtn:focus{outline:none}.ui-calendar-modeBtn.active,.ui-calendar-modeBtn:active{background:#ff7dc5;color:#fff;z-index:2}.ui-calendar .k-calendar-header-center,.ui-calendar .k-calendar-week-title-item{color:#ff7dc5}.ui-calendar-item{padding:5px 10px;color:#666}.ui-calendar-item.is-otherMonth{color:#bbb}.ui-calendar-item.is-today .ui-calendar-item-date{position:relative;display:inline-block;background:#ff7dc5;color:#fff;width:20px;height:20px;border-radius:50%;text-align:center;line-height:20px;top:-1px}.ui-calendar-item-name{font-size:12px}.ui-calendar-item-name>*{vertical-align:middle}.ui-calendar-item-name .del{display:inline-block;cursor:pointer;color:inherit;margin-bottom:-2px}.ui-calendar .vue-calendar-body-row{height:auto}");!function(){"use strict";Object.defineProperty(exports,"__esModule",{value:!0});var e=t(require("../src/dayjs")),a=t(require("./data"));function t(e){return e&&e.__esModule?e:{default:e}}exports.default={name:"App",components:{Calendar:e.default},data:function(){return{currMonth:"",dateData:a.default.Array,mode:"month"}},methods:{onMonthChange:function(e){},changeDate:function(){this.$refs.calendar.changeDate("2017-12-12")},deleteItem:function(e){this.dateData=this.dateData.filter(function(a){return a.title!==e})},renderHeader:function(e){var a=e.prev,t=e.next,n=e.selectedDate,i=this.$createElement,r=i("div",{class:["ui-calendar-modeBtn"],on:{click:a}},["prev"]),d=i("div",{class:["ui-calendar-modeBtn"],on:{click:t}},["next"]);return i("div",[r,i("div",{class:["ui-calendar-modeBtn"]},[n]),d])}}}}(),module.exports.__esModule&&(module.exports=module.exports.default);var a="function"==typeof module.exports?module.exports.options:module.exports;a.render=function(){var e=this,a=e.$createElement,t=e._self._c||a;return t("div",{staticClass:"page-container"},[t("h1",[e._v("A Vue2 Full Calendar")]),e._v(" "),t("h2",{on:{click:e.changeDate}},[e._v("Has month and week two mode. And you can custom all style")]),e._v(" "),t("div",{staticClass:"container"},[t("Calendar",{ref:"calendar",staticClass:"ui-calendar",attrs:{"start-day":e.currMonth,dateData:e.dateData,"on-month-change":e.onMonthChange,mode:e.mode,"render-header":e.renderHeader},scopedSlots:e._u([{key:"default",fn:function(a){return t("div",{class:["ui-calendar-item",{"is-otherMonth":a.isPrevMonth||a.isNextMonth,"is-today":a.isToday}]},[t("div",{class:["ui-calendar-item-date"]},[e._v("\n          "+e._s(a.date.date)+"\n        ")]),e._v(" "),e._l(a.data,function(a,n){return t("div",{key:n,staticClass:"ui-calendar-item-name"},[t("span",[e._v(e._s(a.title))]),e._v(" "),t("span",{staticClass:"del",on:{click:function(t){e.deleteItem(a.title)}}},[e._v("✖️")])])})],2)}}])},[t("div",{staticClass:"ui-calendar-header__left",attrs:{slot:"header-left"},slot:"header-left"},[t("button",{class:["ui-calendar-modeBtn",{active:"month"===e.mode}],on:{click:function(a){e.mode="month"}}},[e._v("\n          Month\n        ")]),e._v(" "),t("button",{class:["ui-calendar-modeBtn",{active:"week"===e.mode}],on:{click:function(a){e.mode="week"}}},[e._v("\n          Week\n        ")])])])],1)])},a.staticRenderFns=[];
},{"vueify/lib/insert-css":8,"../src/dayjs":9,"./data":7}],2:[function(require,module,exports) {
"use strict";var e=require("vue"),u=n(e),r=require("./App.vue"),t=n(r);function n(e){return e&&e.__esModule?e:{default:e}}new u.default({el:"#app",components:{App:t.default},render:function(e){return e(t.default)}});
},{"vue":5,"./App.vue":4}]},{},[2])
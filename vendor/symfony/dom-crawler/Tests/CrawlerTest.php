...
HTML;
    ...
    public function getBaseTagWithFormData()
    {
        return array(
            ...
            array('/basepath', '/dashboard/scouts/accounts/register', 'http://domain.com/dashboard/scouts/accounts/register', 'http://domain.com/dashboard/scouts/accounts/register', '<base> tag does work with a path and form action'),
            array('/basepath', '', 'http://domain.com/dashboard/scouts/accounts/register', 'http://domain.com/dashboard/scouts/accounts/register', '<base> tag does work with a path and empty form action'),
            array('http://base.com/', '/dashboard/scouts/accounts/register', 'http://base.com/dashboard/scouts/accounts/register', 'http://domain.com/dashboard/scouts/accounts/register', '<base> tag does work with a URL and form action'),
            ...
            array('http://base.com/path', '/dashboard/scouts/accounts/register', 'http://base.com/dashboard/scouts/accounts/register', 'http://domain.com/path/form', '<base> tag does work with a URL and form action'),
        );
    }

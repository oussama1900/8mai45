        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto"  >
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link {{ $nav_color  }} {{ Route::currentRouteNamed('cubs') ? 'activenav' : '' }} dropdown-toggle" href="#" id="dropdown04" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="font-size: medium;margin-right: 8px;margin-left: 8px">الأفواج</a>
                    <div class="dropdown-menu {{ $nav_color }} align-items-baseline dropdown-menu-right" aria-labelledby="dropdown04">

                                    <a class="dropdown-item {{ $nav_color }} {{ Route::currentRouteNamed('cubs') ? 'activenav' : '' }}" style="text-align:center ;font-size: large;color: #ffffff;"  href="/cubs" >الكشاف</a>

                                    <a class="dropdown-item {{ $nav_color }} align-items-center" style="text-align:center ;font-size: large ; color: #ffffff;" href="#">الأشبال</a>

                                    <a class="dropdown-item {{ $nav_color }}" style="text-align:center ;font-size: large; color: #ffffff;"  href="#">الجوالة</a>

                                    <a class="dropdown-item {{ $nav_color }} align-items-center" style="text-align:center ;font-size: large; color: #ffffff;" href="#">المتقدم</a>

        ...
        <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
            ...
            <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right" style="height: 80px">
                <li id="notification" style="background-color:white">
                  <Notification  :unreads="{{auth()->user()->unreadnotifications}}" :userid="{{auth()->user()->scout_id}}" :notification="{{auth()->user()->unreadnotifications}}"></Notification>
...
$(document).ready(function() {
    ...
    $(document).click(function(e) {
        if(e.target != $('#chatro')[0] && $("#mySidenav").find(e.target).length === 0){

                                                               ...
                                                               <tbody>
                                                                  <tr>
                                                                     <td align="center" width="100%">
                                                                        <h1 style="padding:0;margin:0;color:#ffffff;font-weight:500;font-size:20px;line-height:24px;text-align:center">حساب جديد</h1>
                                                                     </td>
                                                                  </tr>
                                                               </tbody>
                                                            </table>
                                                               ...
                                                               <tbody>
                                                                  <tr>
                                                                     <td align="center" width="100%" style="padding: 0 15px;text-align: justify;color: rgb(76, 76, 76);font-size: 12px;line-height: 18px;">
                                                                      ...
                                                                      <h3>  <p style="margin: 20px 0 30px 0;text-align: center;line-height: 35px;font-family:Droid Naskh">  ألف مبروك لقد تم ترقيتك لتكون ضمن اسرة الطاقم القيادي لفوج الفلاح العريق وبهذا الصدد نتشرف بمنحك حساب الكتروني في الموقع الالكتروني الخاص بنا  <b> <a href="www.falehscout.com" style="text-decoration:none">فوج الفلاح</a>  </b></p></h3>
                                                                        ...
                                                                        <div style="font-weight: 200; text-align: center; margin: 25px;"><a href="www.admin.falehscout.com" style="padding:0.6em 1em;border-radius:600px;color:#ffffff;font-size:14px;text-decoration:none;font-weight:bold;text-align:right;font-size:medium" dir="rtl" class="button-color" >اضغظ لتسجيل الدخول</a></div>
                                                                     </td>
                                                                  </tr>
                                                               </tbody>
                                                            </table>

                    ...
                    <div class="row">
                        <div class="col">
                            <section class="card card-section">
                                <div class=" one" style="background: -webkit-linear-gradient(15deg, #ffffff 68%, #2A4E2A, #2A4E2A 69%, transparent, transparent 85%),url('');z-index:1">
                                    <div class="row">
                                 ...
                                 <div style="background-color:red; position:absolute;right:0; width:50%;height:100% !important;padding:0 !important;margin:0 !important;
...
@endsection
@section('icon')
    <link rel="icon" href="{{ asset('/images/scout-logo.png') }}" >
@endsection

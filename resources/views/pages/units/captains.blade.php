                    ...
                    <div class="row">
                        <div class="col">
                            <section class="card-section">
                                <div class=" one" style="background: -webkit-linear-gradient(15deg, #ffffff 68%, #25598D, #25598D 69%, transparent, transparent 85%),url('{{asset('images/PostCover/')}}{{"/".$post->cover_image}}')">
                                    <div class="row">
...
@endsection
@section('styles')
    <link rel="stylesheet" href="/css/captains.css">
    <style>
        .page-link{
            color: #000 !important;
        }

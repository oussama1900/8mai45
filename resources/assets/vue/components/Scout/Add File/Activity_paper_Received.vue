    ...
    <div class="container col-md-11 col-sm-11 col-xs-11 text-center card " style="padding-right: 0px;padding-left:0px">
        ...
        <div  class="card-body" style="margin:10px;">
            <div class="row form-group">
                ...
                <div class="col-md-3" style="float:right">
                    <label style="float:right;font-size: medium" class="label_title"> السنة</label>
...
<script>
    ...
    export default {
        ...
        created:function () {
            ...
            var vm  =this;
            axios.put('/api/GetActivity_Paper_Report',{month:vm.month,year:vm.year}).then(function (response) {

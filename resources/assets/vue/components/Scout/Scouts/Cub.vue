<template>
        ...
        <div style="margin-top: 10px;float:left;padding-right:10px;padding-left:10px">
            ...
            <div class="col-md-9 col-xs-12"   >
                <div class="form-group has-feedback has-search">
                    ...
                    <input type="text" class="form-control" id="search" dir="rtl" style="padding-right:25px" placeholder="ابحث عن شبل" v-on:keyup="searchcub()">
                </div>
            </div>
        </div>
    ...
    <!--</span>-->
        ...
        <sweet-modal ref="confirmation" icon="warning">
            <h3>هل أنت متأكد من حذف هذا الشبل</h3>
       ...
       data(){
        ...
        methods:{
            setScoutCode(cub){
                ...
                var scout_code= 'SF-'+ membershipdate.substr(2,2)+'-'+cub.scout.scout_id;
                return scout_code;
            ...
            export_cubs_list(){
                ...
                axios({
                    ...
                    link.download = 'قائمة الأشبال.pdf';
                    link.click();
                    vm.show = false;
            ...
            searchcub(){
                ...
                if(name.localeCompare('')===0){
                    for(i = 0 ;i<this.MyScouts.length;i++){
                        $('#cub'+this.MyScouts[i].scout_id).show("fast");
                    ...
                    for(i = 0 ;i<this.MyScouts.length;i++){
                        ...
                        if(this.MyScouts[i].scout.last_name.localeCompare(name)===0 || this.MyScouts[i].scout.first_name.localeCompare(name)===0 || fullname.localeCompare(name)===0 || fullname_reverse.localeCompare(name)===0)
                        {
                            ...
                            $('#cub'+this.MyScouts[i].scout_id).hide("slow");
                        }

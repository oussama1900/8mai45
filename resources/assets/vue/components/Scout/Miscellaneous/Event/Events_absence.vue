<template>
    ...
    <div class="container  " style="background-color: transparent">
        <div class="row">
            ...
            <div  v-for="absence in absenceevents" :key="absence.id" class="col-sm-3 hoverable card" style="margin: 10px 10px; width:30%;padding: 0 0 ">
                ...
                <div class="card-footer" style="background-color:white;height: 50px; margin: 0 0; padding: 0 0" >
                        ...
                        <div class="col-sm-2" style="height: 100%; margin: 0 0; padding: 0 0">
                            <a href="#">
                              <img class="img-circle":src="'/images/Captain/'+absence.creator.image"  style="height: 70%; width: 70%;margin:15% 15%" v-if="absence.creator.image.localeCompare('')!==0">

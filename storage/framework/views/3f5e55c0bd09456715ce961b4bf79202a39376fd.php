<?php $__env->startSection('content'); ?>
  <link rel="stylesheet" href="<?php echo e(URL::to('/')); ?>/assets/examples/css/structure/chat.css">  
<div class="page-header">
  <h1 class="page-title font_kufi">Chat </h1>
              ...
              <div class="chat">
                <div class="chat-avatar">
                  <a class="avatar" data-toggle="tooltip" href="#" data-placement="right" title="June Lane">
                    <img src="<?php echo e(URL::to('/')); ?>/global/portraits/4.jpg" alt="June Lane">
                  </a>
                </div>
                <div class="chat-body">
              ...
              <div class="chat chat-left">
                <div class="chat-avatar">
                  <a class="avatar" data-toggle="tooltip" href="#" data-placement="left" title="Edward Fletcher">
                    <img src="<?php echo e(URL::to('/')); ?>/global/portraits/5.jpg" alt="Edward Fletcher">
                  </a>
                </div>
                <div class="chat-body">
                  <div class="chat-content">

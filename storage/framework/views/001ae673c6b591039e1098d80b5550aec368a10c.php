    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel" style="width: 100% ;height:360px;margin-bottom:10px; text-align: center; position:center ">
        ...
        <div class="carousel-inner">
            ...
            <div class="item active">
                <img src="<?php echo e(asset('images/img.jpg')); ?>" alt="وحدة الاشبال" style="width:100%;height:360px">
            ...
            <div class="item">
                <img src="<?php echo e(asset('images/img2.jpg')); ?>" alt="وحدة الكشاف" style="width:100%;height:360px">
                <div class="carousel-caption">
            ...
            <div class="item">
                <img src="<?php echo e(asset('images/img3.jpg')); ?>" alt="وحدة المتقدم" style="width:100%;height:360px">
                <div class="carousel-caption">

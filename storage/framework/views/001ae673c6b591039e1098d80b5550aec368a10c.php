<?php $__env->startSection('content'); ?>
    ...
    <!---->
<?php if(!empty($cubPost)): ?>
    <section class="home-event-2 ">
        <div class="row h-100 justify-content-center align-items-center">
            <div class="card card1 bg-light mb-3 col-md-6" id="event-text-card1" style="padding: 10px ">
                <div class=" card-body">
                    <h3 class="card-title"><?php echo e($cubPost->post_title); ?></h3>
                    <h5><?php echo e(substr($cubPost->post_date, 0, 10)); ?></h5>
                    <h6 style="font-size: 12px;">وحدة الكشاف</h6>

                    <p class="card-text" style="font-family:'scheherazade' ;font-size: 150%;"><?php echo $cubPost->post_summary; ?></p>
                    <div class="row">
                        <hr style="width: 50%;margin-left:25% !important; margin-right:25% !important; border-color:gray !important;">
                    </div>
                    <div class="row">
                        <a href="/posts/<?php echo e($cubPost->post_id); ?>" style="margin-left:42%; ">اقرأ المزيد</a>
                    </div>
                </div>
            </div>
            <div class="
            card card2 mb-3 col-md-6">
                <div class="card-body" style=" background-image: url(<?php echo e(asset('images/PostCover/')); ?><?php echo e("/".$cubPost->cover_image); ?>);">
...
<?php endif; ?>
    <!---->
<?php if(!empty($scoutPost)): ?>
    <section class="home-event-2 ">
        <div class="row h-100 justify-content-center align-items-center">
            <div class="card card2  mb-3 col-md-6">
                <div class="card-body" style=" background-image: url(<?php echo e(asset('images/PostCover/')); ?><?php echo e("/".$scoutPost->cover_image); ?>);">
                    <div class="color-filter"></div>
                </div>
            </div>
            <div class="card card1 bg-light mb-3 col-md-6" id="event-text-card2" style="padding: 10px ">
                <div class=" card-body">
                    <h3 class="card-title"><?php echo e($scoutPost->post_title); ?></h3>
                    <h5><?php echo e(substr($scoutPost->post_date, 0, 10)); ?></h5>
                    <h6 style="font-size: 12px;">وحدة الاشبال</h6>

                    <p class="card-text" style="font-family:'scheherazade' ;font-size: 150%;"><?php echo $scoutPost->post_summary; ?></p>
                    <div class="row">
                        <hr style="width: 50%;margin-left:25% !important; margin-right:25% !important; border-color:gray !important;">
                    </div>
                    <div class="row">
                        <a href="/posts/<?php echo e($scoutPost->post_id); ?>" style="margin-left:42%; ">اقرأ المزيد</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php endif; ?>
    ...
    <section class="home-event-3">
        <div class="row h-100 justify-content-center align-items-center">
            <div class="col-md-6">
                <?php if(!empty($ascoutPost)): ?>
                <div class="row h-100">
                    <div class="card event-card1 bg-light mb-3 col-md-12">
                        <div class="card-body" style=" background-image: url(<?php echo e(asset('images/PostCover/')); ?><?php echo e("/".$ascoutPost->cover_image); ?>);">
                            <div class="color-filter"></div>
                            <div class="side-filter1"></div>
                            <div class="card-title">
                                <h3><?php echo e($ascoutPost->post_title); ?></h3>
                                <h4> <?php echo e(substr($ascoutPost->post_date, 0, 10)); ?> </h4>
                                <h5> وحدة المتقدم </h5>

                            </div>
                            <p class="card-text"><?php echo $ascoutPost->post_summary; ?></p>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
                <?php if(!empty($travelerPost)): ?>
                <div class="row h-100">
                    <div class="card bg-light event-card1 mb-3 col-md-12">
                        <div class="card-body" style=" background-image: url(<?php echo e(asset('images/PostCover/')); ?><?php echo e("/".$travelerPost->cover_image); ?>);">
                            <div class="color-filter"></div>
                            <div class="side-filter1"></div>
                            <div class="card-title">
                                <h3><?php echo e($travelerPost->post_title); ?> </h3>
                                <h4><?php echo e(substr($travelerPost->post_date, 0, 10)); ?> </h4>
                                <h5> وحدة الجوالة </h5>

                            </div>
                            <p class="card-text"><?php echo $travelerPost->post_summary; ?></p>
                        </div>
                    </div>
                </div>
                <?php endif; ?>
            </div>
            <?php if(!empty($capPost)): ?>
            <div class="col-md-6">
                <div class="row h-100 ">
                    <div class="card bg-light event-card2 mb-3 col-md-12">
                        <div class="card-body" style=" background-image: url(<?php echo e(asset('images/PostCover/')); ?><?php echo e("/".$capPost->cover_image); ?>);">
                            <div class="color-filter"></div>
                            <div class="side-filter2"></div>
                            <div class="card-title">
                                <h3><?php echo e($capPost->post_title); ?></h3>
                                <h4> <?php echo e(substr($capPost->post_date, 0, 10)); ?> </h4>
                                <h5> وحدة القادة </h5>

                            </div>
                            <p class="card-text"><?php echo $capPost->post_summary; ?></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="home-grid">
        ...
        <div class="row" style="width:100%;margin: 0;">
            <div class="col grid-image" style="background-image:url(<?php echo e(asset('images/EventImages/')); ?><?php echo e("/".$events[0]->event_image); ?>);">

            </div>
            <div class="col grid-text" id="grid-text-one">
                <div class=" card-body" style="margin-top:10%">
                    <h3 class="card-title"><?php echo e($events[0]->post_title); ?></h3>
                    <h5><?php echo e(substr($events[0]->event_time, 0, 10)); ?></h5>
                    <?php
                        $unit_name = '';
                    ...
                    ?>
                    <h6 style="font-size: 12px;"><?php echo e($unit_name); ?></h6>

                    <p class="card-text" style="font-family:'scheherazade' ;font-size: 135%;"><?php echo substr($events[0]->description,0,500); ?>...</p>
                    <div class="row">
                        <hr style="width: 50%;margin-left:25% !important; margin-right:25% !important; ">
                    </div>
                    <div class="row">
                        <a href="/events/<?php echo e($events[0]->event_id); ?>" style="margin-left:42%; ">اقرأ المزيد</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class=" row" style="width:100%;margin :0 ;">
            <div class="col grid-text" id="grid-text-one">
                <div class=" card-body" style="margin-top:10%">
                    <h3 class="card-title"><?php echo e($events[1]->post_title); ?></h3>
                    <h5><?php echo e(substr($events[1]->event_time, 0, 10)); ?></h5>
                    <?php
                        $unit_name = '';
                    ...
                    <p class="card-text" style="font-family:'scheherazade' ;font-size: 135%;"><?php echo substr($events[1]->description,0,500); ?>...</p>
                    <div class="row">
                        <hr style="width: 50%;margin-left:25% !important; margin-right:25% !important; ">
                    </div>
                    <div class="row">
                        <a href="/events/<?php echo e($events[1]->event_id); ?>" style="margin-left:42%; ">اقرأ المزيد</a>
                    </div>
                </div>
            </div>
            <div class="col grid-image " style="background-image:url(<?php echo e(asset('images/EventImages/')); ?><?php echo e("/".$events[1]->event_image); ?>);">

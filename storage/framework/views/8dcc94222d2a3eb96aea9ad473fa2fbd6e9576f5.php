...
<link rel="stylesheet" href="<?php echo e(URL::to('/')); ?>/assets/examples/css/uikit/icons.css">
  <link rel="stylesheet" href="<?php echo e(URL::to('/')); ?>/global/fonts/7-stroke/7-stroke.css">
  <link rel="stylesheet" href="<?php echo e(URL::to('/')); ?>/global/fonts/ionicons/ionicons.css">
  <link rel="stylesheet" href="<?php echo e(URL::to('/')); ?>/global/fonts/material-design/material-design.css">
  <link rel="stylesheet" href="<?php echo e(URL::to('/')); ?>/global/fonts/mfglabs/mfglabs.css">
  <link rel="stylesheet" href="<?php echo e(URL::to('/')); ?>/global/fonts/open-iconic/open-iconic.css">
  <link rel="stylesheet" href="<?php echo e(URL::to('/')); ?>/global/fonts/themify/themify.css">
  <link rel="stylesheet" href="<?php echo e(URL::to('/')); ?>/global/fonts/weather-icons/weather-icons.css">
  <link rel="stylesheet" href="<?php echo e(URL::to('/')); ?>/global/fonts/glyphicons/glyphicons.css">
  <link rel="stylesheet" href="<?php echo e(URL::to('/')); ?>/global/fonts/octicons/octicons.css">
            ...
            <div class="col-lg-4 col-sm-6">
              ...
              <div class="example example-well overlay overlay-hover">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="<?php echo e(URL::to('/ElementsController/webIcons')); ?>">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-sm-6">
              ...
              <div class="example example-well overlay overlay-hover">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="<?php echo e(URL::to('/ElementsController/fontAwesome')); ?>">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-sm-6">
              ...
              <div class="example example-well overlay overlay-hover">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="<?php echo e(URL::to('/ElementsController/strokeIcon')); ?>">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-sm-6">
              ...
              <div class="example example-well overlay overlay-hover">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="<?php echo e(URL::to('/ElementsController/brandIcons')); ?>">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-sm-6">
              ...
              <div class="example example-well overlay overlay-hover">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="<?php echo e(URL::to('/ElementsController/glyphicons')); ?>">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-sm-6">
              ...
              <div class="example example-well overlay overlay-hover">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="<?php echo e(URL::to('/ElementsController/ionicons')); ?>">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-sm-6">
              ...
              <div class="example example-well overlay overlay-hover">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="<?php echo e(URL::to('/ElementsController/materialDesign')); ?>">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-sm-6">
              ...
              <div class="example example-well overlay overlay-hover">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="<?php echo e(URL::to('/ElementsController/mfglabs')); ?>">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-sm-6">
              ...
              <div class="example example-well overlay overlay-hover">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="<?php echo e(URL::to('/ElementsController/openIconic')); ?>">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-sm-6">
              ...
              <div class="example example-well overlay overlay-hover">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="<?php echo e(URL::to('/ElementsController/themify')); ?>">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-sm-6">
              ...
              <div class="example example-well overlay overlay-hover">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="<?php echo e(URL::to('/ElementsController/weatherIcons')); ?>">Read More</a>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-sm-6">
              ...
              <div class="example example-well overlay overlay-hover">
                ...
                <div class="overlay-panel overlay-background overlay-fade text-center vertical-align">
                  <a class="btn btn-outline btn-inverse vertical-align-middle" href="<?php echo e(URL::to('/ElementsController/octicons')); ?>">Read More</a>
                </div>
              </div>
            </div>
          </div>

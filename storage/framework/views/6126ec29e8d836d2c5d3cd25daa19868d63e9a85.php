...
<div class="page-header">
  <h1 class="page-title font_kufi">Overlay </h1>
          ...
          <div class="row row-lg">
            ...
            <div class="col-md-6 col-lg-4">
              ...
              <div class="example-wrap margin-lg-0">
                ...
                <div class="example">
                  <figure class="overlay">
                    <img class="overlay-figure" src="<?php echo e(URL::to('/')); ?>/global/photos/placeholder.png" alt="...">
            ...
            <div class="col-md-6 col-lg-4">
              ...
              <div class="example-wrap margin-md-0">
                ...
                <div class="example">
                  <figure class="overlay overlay-hover">
                    <img class="overlay-figure" src="<?php echo e(URL::to('/')); ?>/global/photos/placeholder.png" alt="...">
                    <img class="overlay-panel overlay-image overlay-fade" src="<?php echo e(URL::to('/')); ?>/global/photos/placeholder.png"
                    alt="...">
                  </figure>
                </div>
              </div>
          ...
          <div class="row row-lg">
            ...
            <div class="col-md-6 col-lg-4">
              ...
              <div class="example-wrap">
                ...
                <div class="example">
                  <figure class="overlay overlay-hover">
                    <img class="overlay-figure overlay-scale" src="<?php echo e(URL::to('/')); ?>/global/photos/placeholder.png"
                    alt="...">
                    <figcaption class="overlay-panel overlay-background">
                      <h3>Title</h3>
                      <p>Lorem <a href="javascript:void(0)">ipsum dolor</a> sit amet,
            ...
            <div class="col-md-6 col-lg-4">
              ...
              <div class="example-wrap">
                ...
                <div class="example">
                  <figure class="overlay overlay-hover">
                    <img class="overlay-figure overlay-spin" src="<?php echo e(URL::to('/')); ?>/global/photos/placeholder.png"
                    alt="...">
                    <figcaption class="overlay-panel overlay-background overlay-fade">
                      <h3>Title</h3>
                      <p>Lorem <a href="javascript:void(0)">ipsum dolor</a> sit amet,
            ...
            <div class="col-md-6 col-lg-4">
              ...
              <div class="example-wrap">
                ...
                <div class="example">
                  <figure class="overlay overlay-hover">
                    <img class="overlay-figure overlay-grayscale" src="<?php echo e(URL::to('/')); ?>/global/photos/placeholder.png"
                    alt="...">
                    <figcaption class="overlay-panel overlay-background overlay-fade">
                      <h3>Title</h3>
                      <p>Lorem <a href="javascript:void(0)">ipsum dolor</a> sit amet,

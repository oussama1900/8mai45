<?php $__env->startSection('content'); ?>
 <link rel="stylesheet" href="<?php echo e(URL::to('/')); ?>/global/vendor/flag-icon-css/flag-icon.css">
  <link rel="stylesheet" href="<?php echo e(URL::to('/')); ?>/global/vendor/asrange/asRange.css">
  <link rel="stylesheet" href="<?php echo e(URL::to('/')); ?>/assets/examples/css/uikit/icon.css">
  <!-- Fonts -->
...
<div class="page-header">
  <h1 class="page-title font_kufi">Web Icons </h1>
  <div class="page-header-actions">
	<ol class="breadcrumb">
		<li><a href="<?php echo e(URL::to('/icons')); ?>">Icons</a></li>
